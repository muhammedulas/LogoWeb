...
export class PaymentPlansService {
  ...
  getPaymentPlans(lim:number,offset:number,q?:string){
    ...
    else return this.http.get<paymentPlanResp>(this.rootUrl + "/api/v1/paymentPlans?offset=" + offset + "&limit=" + lim + "&q=(CODE like '*" + q + "*' or NAME like '*" + q + "*')" + "&withCount=true", { headers }) 
  }
