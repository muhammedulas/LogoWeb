...
import { exportTypedSalesInvoice } from 'src/app/models/exportTypedSalesInvoice';
import { ExportTypedPurchaseInvoicesService } from 'src/app/services/exportTypedPurchaseInvoices.service';
import { ExportTypedSalesInvoiceService } from 'src/app/services/exportTypedSalesInvoices.service';

@Component({
  selector: 'app-ik-satis-faturalari',
  templateUrl: './ik-satis-faturalari.component.html',
  styleUrls: ['./ik-satis-faturalari.component.scss']
})
export class IkSatisFaturalariComponent implements OnInit {

  constructor(
    private toast: ToastrService,
    private router: Router,
    private service: ExportTypedSalesInvoiceService,
  ...
  public selectedRecord: exportTypedSalesInvoice = new exportTypedSalesInvoice();
  public dataSet: exportTypedSalesInvoice[] = []
  ...
  select(rec: exportTypedSalesInvoice) {
...
/*     var data
  ...
  setRecLimit(newLim: number) {
    ...
    this.getAllRecords(0)
    this.pageCount = Math.floor(this.itemCount / this.recLimit)
    this.router.navigate(['/ihracat/ik-satis-faturalari'])
  }
