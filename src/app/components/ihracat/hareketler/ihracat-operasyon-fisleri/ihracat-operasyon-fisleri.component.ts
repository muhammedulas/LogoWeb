...
import { exportOperationSlip } from 'src/app/models/exportOperationSlip';
import { ExportOperationSlipsService } from 'src/app/services/exportOperationSlips.service';

@Component({
  selector: 'app-ihracat-operasyon-fisleri',
  templateUrl: './ihracat-operasyon-fisleri.component.html',
  styleUrls: ['./ihracat-operasyon-fisleri.component.scss']
})
export class IhracatOperasyonFisleriComponent implements OnInit {

  constructor(
    private toast: ToastrService,
    private router: Router,
    private service: ExportOperationSlipsService,
  ...
  public selectedRecord: exportOperationSlip = new exportOperationSlip();
  public dataSet: exportOperationSlip[] = []
  private errorMsg: string = "";
  private errorCode: string = "";
  public loaded: boolean = false;
  public displayedColumns: string[] = ["EximFileCode", "Date", "FicheNo", "Type", "ArpCode", "CstDate"]
  ...
  select(rec: exportOperationSlip) {
...
/*     var data
  ...
  setRecLimit(newLim: number) {
    ...
    this.getAllRecords(0)
    this.pageCount = Math.floor(this.itemCount / this.recLimit)
    this.router.navigate(['/ihracat/ihracat-operasyon-fisleri'])
  }
