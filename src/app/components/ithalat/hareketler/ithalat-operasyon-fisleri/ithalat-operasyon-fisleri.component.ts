...
import { importOperationSlip } from 'src/app/models/importOperationSlip';
import { ImportOperationSlipsService } from 'src/app/services/importOperationSlips.service';

@Component({
  selector: 'app-ithalat-operasyon-fisleri',
  templateUrl: './ithalat-operasyon-fisleri.component.html',
  styleUrls: ['./ithalat-operasyon-fisleri.component.scss']
})
export class IthalatOperasyonFisleriComponent implements OnInit {

  constructor(
    private toast: ToastrService,
    private router: Router,
    private service: ImportOperationSlipsService,
  ...
  public selectedRecord: importOperationSlip = new importOperationSlip();
  public dataSet: importOperationSlip[] = []
  ...
  select(rec: importOperationSlip) {
...
/*     var data
  ...
  setRecLimit(newLim: number) {
    ...
    this.getAllRecords(0)
    this.pageCount = Math.floor(this.itemCount / this.recLimit)
    this.router.navigate(['/ithalat/ithalat-operasyon-fisleri'])
  }
