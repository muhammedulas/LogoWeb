...
import { exportMovementSlip } from 'src/app/models/exportMovementSlip';
import { ExportMovementSlipsService } from 'src/app/services/exportMovementSlips.service';

@Component({
  selector: 'app-malzeme-dolasim-fisleri',
  templateUrl: './malzeme-dolasim-fisleri.component.html',
  styleUrls: ['./malzeme-dolasim-fisleri.component.scss']
})
export class MalzemeDolasimFisleriComponent implements OnInit {

  constructor(
    private toast: ToastrService,
    private router: Router,
    private service: ExportMovementSlipsService,
  ...
  public selectedRecord: exportMovementSlip = new exportMovementSlip();
  public dataSet: exportMovementSlip[] = []
...
/*     var data
  ...
  setRecLimit(newLim: number) {
    ...
    this.getAllRecords(0)
    this.pageCount = Math.floor(this.itemCount / this.recLimit)
    this.router.navigate(['/ithalat/malzeme-dolasim-fisleri'])
  }
