...
import { exportNationalizationSlip } from 'src/app/models/exportNationalizationSlip';
import { ExportNationalizationSlipsService } from 'src/app/services/exportNationalizationSlips.service';

@Component({
  selector: 'app-millilestirme-fisleri',
  templateUrl: './millilestirme-fisleri.component.html',
  styleUrls: ['./millilestirme-fisleri.component.scss']
})
export class MillilestirmeFisleriComponent implements OnInit {

  constructor(
    private toast: ToastrService,
    private router: Router,
    private service: ExportNationalizationSlipsService,
  ...
  public selectedRecord: exportNationalizationSlip = new exportNationalizationSlip();
  public dataSet: exportNationalizationSlip[] = []
  ...
  select(rec: exportNationalizationSlip) {
...
/*   add() {
  ...
  setRecLimit(newLim: number) {
    ...
    this.getAllRecords(0)
    this.pageCount = Math.floor(this.itemCount / this.recLimit)
    this.router.navigate(['/ithalat/millilestirme-fisleri'])
  }
