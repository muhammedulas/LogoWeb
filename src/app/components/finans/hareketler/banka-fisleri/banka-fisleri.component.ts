...
@Component({
  selector: 'app-banka-fisleri',
  templateUrl: './banka-fisleri.component.html',
  styleUrls: ['./banka-fisleri.component.scss']
})
export class BankaFisleriComponent implements OnInit {
  ...
  public selectedRecord: bankSlip = new bankSlip();
  public dataSet: bankSlip[] = []
  private errorMsg: string = "";
  private errorCode: string = "";
  public loaded: boolean = false;
  public displayedColumns: string[] = ["Date", "FicheNo", "Type", "Debit", "Credit", "Notes"]
  ...
  edit_inspect(inspectMode: boolean) {
    ...
    this.service.getRecordByID(this.selectedRecord.INTERNAL_REFERENCE).subscribe(res => {
      ...
      this.dialog.open(Dialog_editInspectBankSlipComponent, {
        data: data,
        width: "60vw",
        height: "65vh"
      })
  ...
  setRecLimit(newLim: number) {
    ...
    this.getAllRecords(0)
    this.pageCount = Math.floor(this.itemCount / this.recLimit)
    this.router.navigate(['/finans/banka-fisleri'])
  }
